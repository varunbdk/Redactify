export const audiencePages = {
  "chatgpt-users": {
    ...
    description: "Prepare a safer copy for summarising, analysing, or discussing with ChatGPT—without sending the original document to Redactify.",
    benefits: [
  ...
  "financial-services-professionals": {
    ...
    description: "Review statements and client documents for account holders, account numbers, IBANs, addresses, and reference IDs without uploading the source file to Redactify.",
    benefits: [
